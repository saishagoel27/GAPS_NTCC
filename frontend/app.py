                ...
                with st.spinner("🤖 AI is analyzing your profile..."):
                    ...
                    try:
                        ...
                        if st.button("📄 Generate Full Report", type="secondary"):
                            report = generate_report(st.session_state.prediction_data)
                            b64 = base64.b64encode(report.encode()).decode()
                            href = f'<a href="data:file/txt;base64,{b64}" download="admission_analysis_report.txt">📥 Download Complete Report</a>'
    ...
    if data:
                ...
                with st.expander(f"🎯 Improve {feature} (Impact: {impact:.3f})"):
                    if feature == "GRE":
                        ...
                        **📝 Letter of Recommendation Strategy:**
                        ...
                        - Give them plenty of time (2+ months)
                        - Follow up politely if needed
                        - Consider professional vs academic references
                        """)
        ...
        timeline_data = {
            "Immediate (1-2 weeks)": [
                ...
                "Research target universities thoroughly", 
                "Gather recommendation letter materials"
            ],
            "Short-term (1-3 months)": [
                "Retake GRE/TOEFL if needed",
                "Apply for research opportunities",
                "Network with current students/alumni"
            ],
        ...
        **Set measurable goals:**
        - Target GRE score increase: +10-20 points
        - TOEFL improvement: +5-10 points  
        - Number of research experiences: 1-2 minimum
        - SOP drafts and reviews: 3-5 iterations
        - Strong LOR commitments: 3 professors/supervisors
        """)
